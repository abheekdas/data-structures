...
int dp[10000][10000]; // declaring this as dp array with 10000.
...
{	
	// the time complexity will be O(mn) in this case much better than the standard recursive function..
	if (dp[m][n]!=-1)
